...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T3mmyvsa.Entities.AuditLog", b =>
                {
                    ...
                    b.Property<string>("PrimaryKey").IsRequired().HasMaxLength(100).HasColumnType("nvarchar(100)");
                    b.Property<string>("TableName").IsRequired().HasMaxLength(100).HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("UserId").HasMaxLength(100).HasColumnType("nvarchar(100)");
                    b.HasKey("Id");
            ...
            modelBuilder.Entity("T3mmyvsa.Entities.AuthSession", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RefreshTokenHash").IsRequired().HasMaxLength(88).HasColumnType("nvarchar(88)");
                    b.Property<Guid?>("ReplacedBySessionId").HasColumnType("uniqueidentifier");
                    b.Property<DateTimeOffset?>("RevokedAt").HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("T3mmyvsa.Entities.User", b =>
                {
                    b.Property<string>("Id").HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("T3mmyvsa.Entities.User", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                });
